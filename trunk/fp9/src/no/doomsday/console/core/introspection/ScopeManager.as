package no.doomsday.console.core.introspection 
{
	...
	public class ScopeManager
	{
		...
		public function printMethods():void {
			var m:Array = currentScope.methods;
		...
		public function printVariables():void {
			var a:Array = currentScope.variables;
			var cv:*;
			...
			var b:Array = currentScope.accessors;
		...
		public function printChildren():void {
			var c:Array = currentScope.children;
		...
		public function doSearch(search:String,searchMode:int = SEARCH_METHODS):Array
		{
			var result:Array = [];
